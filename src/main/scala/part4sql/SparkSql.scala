...
//    .config("spark.sql.legacy.allowCreatingManagedTableUsingNonemptyLocation", "true") // spark3 does not need this
    .getOrCreate()
...
//    .saveAsTable("movies")
  ...
  spark.sql(
    """
      ...
      |from employees
      |where
      | hire_date > '1999-01-01' and hire_date < '2000-01-01'
      |""".stripMargin
  ).show()
  ...
  spark.sql(
    """
      ...
      |where
      | e.hire_date > '1999-01-01' and e.hire_date < '2000-01-01'
